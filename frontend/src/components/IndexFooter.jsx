                ...
                <div className="grid grid-cols-2 gap-1 text-xs text-gray-500 dark:text-gray-400">
                  <div>
                    ...
                    <span className="font-medium">
                      {formatNumber(data.high_14d)}
                    </span>
                  </div>
                  <div>
                    <span className="block">14D Low:</span>
                    <span className="font-medium">
                      {formatNumber(data.low_14d)}
                    </span>
                  </div>
                  <div>
                    <span className="block">EMA20:</span>
                    <span className="font-medium">
                      {formatNumber(data.ema_20)}
                    </span>
                  </div>
                  <div>
                    <span className="block">EMA50:</span>
                    <span className="font-medium">
                      {formatNumber(data.ema_50)}
                    </span>
                  </div>
                  <div>
                    <span className="block">MACD:</span>
                    <span
                      className={`font-medium ${data.macd >= 0 ? 'text-green-600' : 'text-red-600'}`}
                    >
                  ...
                  <div>
                    ...
                    <span className="font-medium">
                      {formatPercent(data.choppiness_index)}
                    </span>
                  </div>
                </div>
              </div>
