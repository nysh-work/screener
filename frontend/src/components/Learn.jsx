import { BookOpen, TrendingUp, Calculator, Shield, BarChart3, Lightbulb, AlertTriangle, Target } from 'lucide-react';
...
export default function Learn() {
  ...
  const getColorClasses = (color) => {
    const colors = {
      ...
      green: "bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 border-green-200 dark:border-green-700",
      purple: "bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300 border-purple-200 dark:border-purple-700",
      amber: "bg-amber-100 dark:bg-amber-900 text-amber-700 dark:text-amber-300 border-amber-200 dark:border-amber-700",
      indigo: "bg-indigo-100 dark:bg-indigo-900 text-indigo-700 dark:text-indigo-300 border-indigo-200 dark:border-indigo-700",
    };
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-red-800 dark:text-red-200 leading-relaxed">
              Remember why you built this tool: to <strong>learn</strong> and make <strong>informed decisions</strong> -
              not to gamble. If you find yourself making impulsive decisions, chasing quick profits,
              or investing money you can't afford to lose, <strong>STOP</strong>. Take a break.
              Go back to learning. The stock market will always be there tomorrow.
              Your capital, once lost, may not be.
            </p>
          </div>
        </div>
      </div>
