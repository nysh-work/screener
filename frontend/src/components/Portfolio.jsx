        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
              ...
              <div
                className={`flex items-center text-xl font-bold ${portfolio.summary.total_pnl >= 0 ? 'text-green-600' : 'text-red-600'}`}
              >
            ...
            <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
              ...
              <p
                className={`text-xl font-bold ${portfolio.summary.total_return_pct >= 0 ? 'text-green-600' : 'text-red-600'}`}
              >
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                setNewHolding({ ...newHolding, date: e.target.value })
              }
              className="p-2 border rounded dark:bg-gray-700 dark:border-gray-600 dark:text-white"
            />
            <input
            ...
            <input
              ...
              onChange={(e) =>
                setNewHolding({ ...newHolding, price: e.target.value })
              }
              className="p-2 border rounded dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              required
            />
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            {portfolio.holdings.map((holding) => (
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-right dark:text-gray-300">
                  {holding.quantity}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-right dark:text-gray-300">
                ...
                <td
                  className={`px-6 py-4 whitespace-nowrap text-sm text-right font-medium ${holding.unrealized_pnl >= 0 ? 'text-green-600' : 'text-red-600'}`}
                >
                  {formatCurrency(holding.unrealized_pnl)} (
                  {holding.return_pct?.toFixed(2)}%)
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-right dark:text-gray-300">
                  {formatNumber(holding.ev_ebitda)}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-right dark:text-gray-300">
                  {formatNumber(holding.price_to_book)}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-right dark:text-gray-300">
                  {formatNumber(holding.ema_20)}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-right dark:text-gray-300">
                  {formatNumber(holding.ema_50)}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-right dark:text-gray-300">
                  {formatNumber(holding.macd)}
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-right dark:text-gray-300">
                  {formatNumber(holding.choppiness_index)}
                </td>
